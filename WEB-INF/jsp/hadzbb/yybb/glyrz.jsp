	...
	<div class="container center">
		<div class="searchBox center">
		   <div class="form-inline">
			...
			<select id="czy" name="czy">
			   <c:forEach items="${czylist }" var="l">
			       <option value = "${l.czy}">${l.czy}</option>
			   </c:forEach>
			</select>
			</div>
			<div class="form-inline" style="margin-top:10px;">
			<label class="control-label" > 类型：</label>
			<select id="cklx" name="cklx">
		...
		<span>交易总额：</span> <input type="text" id="zjyje" value="" style="height: 25px;" disabled="disabled" />
...
<script type="text/javascript">
        ...
        $(function () {
            ...
            manager = $("#tt").ligerGrid({
                ...
                url: '${ctx }/queryYybb/queryCzyrzJson.do',
                width: '99%',
                height: '98%',
        ...
        function search() {
         ...
         function exportXml() {
            ...
            var url = cjkEncode("${ctx}/ReportServer?reportlet=操作员日志.cpt&dateb="+dateb+"&datee="+datee+"&cklx="
            		+cklx+"&p1="+dqczy+"&p2="+time+"&czy="+czy+"&gh="+gh);
