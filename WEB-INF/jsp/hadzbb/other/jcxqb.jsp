	...
	<div class="container center">
		<div class="searchBox center">
		   <div class="form-inline">
			...
			<label class="control-label" > 实际就餐天数：</label>
			<input type="text" id="ts"  class="input-medium" /> 
			</div>
			 <div class="form-inline" style="margin-top:10px;">
			&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
        ...
        $(function () {
            ...
            manager = $("#tt").ligerGrid({
                ...
                url: '${ctx }/queryYybb/queryJcxqbJson.do',
                width: '99%',
                height: '98%'
        ...
        function search() {
         ...
         function exportXml() {
            ...
            var url = cjkEncode("${ctx}/ReportServer?reportlet=就餐详情表.cpt&dateb="+dateb+"&datee="+datee+"&gh="
            		+gh+"&p1="+dqczy+"&p2="+time+"&bh="+bh+"&xm="+xm+"&ts="+ts);
