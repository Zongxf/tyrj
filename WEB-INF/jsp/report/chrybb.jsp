...
<body>
    <div class="container center">
      <div class="searchBox center">
       ...
       <div class="contentBox center"> 
             <span style="margin-left:10px;">撤户人数：</span><input type="text" id="zchrs"style="height:25px;"disabled="disabled"/>
 ...
 <script type="text/javascript">
        ...
        function exportXml() {
            ...
            var url = cjkEncode("${ctx}/ReportServer?reportlet=chrybb.cpt&dateb="+dateb+"&datee="+datee+"&p1="+dqczy+"&p2="+time+"&rybh="+bh+"&xm="+xm);
       ...
       var datee = $("#datee").val();
       	...
       	var str = "<style>table,tr,td{font-size:15px;border:1px solid black;text-align:center;border-collapse:collapse;cellspacing='0' ;cellpadding='0';}body,table{width:90%;margin-left:40px;background-color:#ffffff;}.t{font-size:20px;font-weight:blod;}</style>"
       	           +"<table><thead><tr><td width='100%' colspan='8'class='t'>撤户人员报表"
       	        +"<span style='float:left;font-size:15px;margin-left:10px;'>总撤户人数："+$("#zchrs").val()+"</span>"
       	        ...
       	        $.ajax({  
                    url: '${ctx}/query_print/queryChrybbJson.do',  
                    data: {  
