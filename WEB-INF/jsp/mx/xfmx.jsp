   ...
   <div class="searchBox center">
     ...
     <div class="form-inline" style="margin-top:10px;">
        ...
        <input type="text" id="xm"/>&nbsp;&nbsp;&nbsp;&nbsp;                  
               ...
               <button onclick="exportXml();"class="btn btn-default"><i class="icon-search"></i>导出</button>
               <button onclick="doprint();"class="btn btn-default"><i class="icon-search"></i>打印</button>
              </span>
       </div>
       </div>
       <div class="contentBox center">
           <span >消费总额：</span><input type="text" id="zxfje"style="height:25px;"disabled="disabled"/>
...
<script type="text/javascript">
        ...
        //导出excel
         function exportXml() {
            ...
            var url = cjkEncode("${ctx}/ReportServer?reportlet=xfmx.cpt&dateb="+dateb+"&datee="+datee+"&p1="+dqczy+"&p2="+time+"&rybh="+bh+"&xm="+xm);
        ...
        //打印
         function doprint(){
        	...
        	var str = "<style>table,tr,td{font-size:15px;border:1px solid black;text-align:center;border-collapse:collapse;cellspacing='0' ;cellpadding='0';}body,table{width:90%;margin-left:40px;background-color:#ffffff;}.t{font-size:20px;font-weight:blod;}</style>"
        	           +"<table><thead><tr><td width='100%' colspan='7'class='t'>消费明细表"
        	           +"<span style='float:left;font-size:15px;margin-left:10px;'>总消费金额："+$("#zxfje").val()+"</span>"
        	           ...
        	           $.ajax({  
        	                url: '${ctx}/query_print/queryXfmxJson.do',  
        	                data: {  
        	                ...
        	                success: function (data) {  
        	                	var LODOP = getLodop(); 
        	                	 ...
        	                	 str=str+"</tbody><tfoot><tr><td width='100%' colspan='7' tindex='1'>"
