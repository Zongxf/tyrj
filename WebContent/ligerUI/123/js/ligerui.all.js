...
(function ($)
{
    ...
    $.ligerDialog.download = function (title)
    {
     
        return $.ligerDialog.open({ cls: 'l-dialog-waittingdialog',title:'文件下载' ,type: 'none', content: '<div style="padding:10px">' + title + '</div>', allowClose: true });
    };
