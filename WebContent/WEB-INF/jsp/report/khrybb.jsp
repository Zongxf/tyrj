...
<div class="container center">
    ...
    <div class="form-inline">
      ...
      <div class="contentBox center">     
             <span style="margin-left:10px;">开户人数：</span><input type="text" id="zkhrs"style="height:25px;"disabled="disabled"/>
 ...
 <script type="text/javascript">
        ...
        var datee = $("#datee").val();
       	var str = "<style>table,tr,td{font-size:15px;border:1px solid black;text-align:center;border-collapse:collapse;cellspacing='0' ;cellpadding='0';}body,table{width:90%;margin-left:40px;background-color:#ffffff;}.t{font-size:20px;font-weight:blod;}</style>"
       	           +"<table><thead><tr><td width='100%' colspan='7'class='t'>开户人员报表"
       	        +"<span style='float:left;font-size:15px;margin-left:10px;'>总开户人数："+$("#zkhrs").val()+"</span>"
       	        ...
       	        $.ajax({  
                    url: '${ctx}/query_print/queryKhrybbJson.do',  
                    data: {  
