	...
	<div class="container center">
		<div class="searchBox center">
		   <div class="form-inline">
			...
			<label class="control-label" > 餐别类型：</label>
			<select id="cblx" name="cblx">
			  <option value="早餐">早餐</option>
			  <option value="午餐">午餐</option>
			  <option value="晚餐">晚餐</option>
			  <option value="夜宵">夜宵</option>
			  <option value="非时段">非时段</option>
			</select> 
			</div>
			<div class="form-inline" style="margin-top:10px;">
			<label class="control-label" > 场所：</label>
			<span class="btn-group"style="height:23px;">
			<input type="text" id="cs"  style="margin-right:0px;padding-right:0px;border-radius:0px;"/> 
...
<script type="text/javascript">
        ...
        $(function () {
            ...
            manager = $("#tt").ligerGrid({
                ...
                url: '${ctx }/queryYybb/queryCkcbrbJson.do',
                width: '99%',
                height: '98%'
        ...
        function search() {
         ...
         function exportXml() {
            ...
            var url = cjkEncode("${ctx}/ReportServer?reportlet=ckcbrb.cpt&dateb="+dateb+"&datee="+datee+"&cblx="
            		+cblx+"&p1="+dqczy+"&p2="+time);
