	...
	<div class="container center">
		<div class="searchBox center">
		   <div class="form-inline">
			...
			<input type="text" id="dateb"onclick="WdatePicker({startDate: '%y-%M-01 00:00:00' ,maxDate:'#F{$dp.$D(\'datee\')}',dateFmt:'yyyy-MM-dd HH:mm:ss'})">
		...
		<div class="contentBox center">
		    <span>交易前总额：</span> <input type="text" id="jyqze" value="" style="height: 25px;" disabled="disabled" />
		    <span>圈存总额：</span> <input type="text" id="jyze" value="" style="height: 25px;" disabled="disabled" />
		    <span>交易后总额：</span> <input type="text" id="jyhze" value="" style="height: 25px;" disabled="disabled" />
...
<script type="text/javascript">
        ...
        function exportXml() {
            ...
            var url = cjkEncode("${ctx}/ReportServer?reportlet=skgrqchz.cpt&dateb="+dateb+"&datee="+datee+"&p1="+dqczy+"&p2="+time+"&gh="+gh+"&bmmc="+bmmc);
