	...
	<div class="container center">
		<div class="searchBox center">
		   <div class="form-inline">
			...
			<span class="btn-group"style="height:23px;">
			<input type="text" id="xm"  style="margin-right:0px;padding-right:0px;border-radius:0px;"/> 
		...
		<span>圈存总额：</span> <input type="text" id="zqcje" value="" style="height: 25px;" disabled="disabled" />
...
<script type="text/javascript">
        ...
        $(function () {
            ...
            manager = $("#tt").ligerGrid({
                ...
                url: '${ctx }/queryha/queryQcdzmxJson.do',
                width: '99%',
                height: '98%',
        ...
        function search() {
         ...
         function exportXml() {
            ...
            var url = cjkEncode("${ctx}/ReportServer?reportlet=qcdzmx.cpt&dateb="+dateb+"&datee="+datee+"&gh="
            		+gh+"&p1="+dqczy+"&p2="+time+"&bm="+bm+"&xm="+xm);
