	...
	<div class="container center">
		<div class="searchBox center">
		   <div class="form-inline">
			...
			<label class="control-label" > 是否领用：</label>
			<select id="sfly">
...
<script type="text/javascript">
        ...
        $(function () {
            ...
            manager = $("#tt").ligerGrid({
                ...
                columns: [{
                    ...
                    {
                        if (parseInt(item.sfly) == 1) return '已领用';
                        return '未领用';
                    }
                ...
                url: '${ctx }/queryha/queryQcdzbJson.do',
                width: '99%',
                height: '98%'
            });
        ...
        function search() {
         ...
         function exportXml() {
            ...
            var url = cjkEncode("${ctx}/ReportServer?reportlet=qcdzb.cpt&dateb="+dateb+"&datee="+datee+"&bm="
            		+bm+"&p1="+dqczy+"&p2="+time+"&gh="+gh+"&xm="+xm);
